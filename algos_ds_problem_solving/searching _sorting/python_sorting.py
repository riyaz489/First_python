...
# then while merging we will use merge sort logic to sort them while merging.
# so if size of array is less than 64 then we algo will simply use insertion sort.
# As quick sort is faster than merge sort but python tim sort still uses merge sort, is because to maintain stability.
